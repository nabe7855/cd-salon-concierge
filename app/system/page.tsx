      ...
      <div className="bg-salon-light min-h-screen pb-20 font-sans">
        ...
        <div className="bg-white border-b border-gray-100">
          <div className="container mx-auto px-4 py-3 text-xs text-gray-400">
            ...
            &gt; <span className="text-gray-600 font-bold">システム詳細</span>
          </div>
        </div>
            ...
            <div className="flex flex-col md:flex-row items-center gap-8 bg-salon-tan p-6 rounded-2xl shadow-sm border border-salon-gold/20">
              ...
              <div className="md:w-2/3">
                <p className="text-sm text-gray-600 leading-relaxed">
                  CTIシステムとは、Computer Telephony
                  Integrationの略で「コンピューター電話統合」とも呼ばわれます。コンピューターと電話系装置を統合し、コールセンターやサポートセンターの情報機能を効率化するシステムです。
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="container mx-auto px-4 max-w-5xl">
            ...
            <div className="space-y-12">
              ...
              <div className="flex flex-col md:flex-row gap-8 items-start bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
                ...
                <div className="md:w-2/3">
                  <h3 className="text-lg font-bold text-gray-800 mb-4 border-l-4 border-salon-pink pl-3">
                    顧客情報をポップアップ表示
                  </h3>
                  <p className="text-sm text-gray-600 leading-relaxed">
          ...
          <div className="container mx-auto px-4 max-w-5xl">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              {[
                ...
                {
                  title: "セラピストの登録",
                  img: "https://images.unsplash.com/photo-1544161515-4ab6ce6db874?auto=format&fit=crop&q=80&w=400",
                },
                {
                  title: "売上レポート",
                  img: "https://images.unsplash.com/photo-1454165833767-027ffea7025c?auto=format&fit=crop&q=80&w=400",
                },
              ].map((item, idx) => (
                <div
                  key={idx}
                  className="bg-white p-4 rounded-2xl shadow-sm flex gap-4 border border-salon-gold/10"
                >
                  <img
                    src={item.img}
                  ...
                  />
                  <div>
                    <h3 className="font-bold text-gray-800 mb-2 border-b border-salon-tan pb-1">
                      {item.title}
                    </h3>
            ...
            <p className="text-[10px] text-gray-400 mt-8 italic text-center">
        ...
        <div className="container mx-auto px-4 max-w-5xl mt-12 pb-12 border-t border-gray-100">
          <nav className="py-4 text-xs text-gray-400">
            ...
            &gt; <span className="text-gray-600">システム詳細</span>
          </nav>
        </div>
      </div>
    </Layout>

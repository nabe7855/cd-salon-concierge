  ...
  return (
    <div className="bg-[#fcf8f4] min-h-screen pb-20 font-sans">
      ...
      <div className="container mx-auto px-4 pt-4 pb-2 text-[10px] text-gray-400">
        <Link to="/" className="hover:text-salon-blue">トップ</Link> &gt; <span className="text-gray-500 font-bold">求人情報</span>
      </div>
      ...
      <section className="container mx-auto px-4 max-w-4xl space-y-16 mb-20">
        ...
        <div className="flex flex-col md:flex-row items-center gap-8 bg-white p-8 rounded-3xl shadow-sm">
          <div className="md:w-1/2">
            <img src="https://images.unsplash.com/photo-1549923746-c502d488b3ea?auto=format&fit=crop&q=80&w=400" alt="Work Life" className="rounded-xl w-full" />
          </div>
          <div className="md:w-1/2">
            <h3 className="text-xl font-bold text-gray-800 mb-4">
              <span className="border-b-2 border-[#f69494] pb-1">自分の時間を大切にできる</span><br />
        ...
        <div className="flex flex-col md:flex-row-reverse items-center gap-8 bg-white p-8 rounded-3xl shadow-sm">
          <div className="md:w-1/2">
            <img src="https://images.unsplash.com/photo-1522071820081-009f0129c71c?auto=format&fit=crop&q=80&w=400" alt="Team Support" className="rounded-xl w-full" />
          </div>
          <div className="md:w-1/2">
            <h3 className="text-xl font-bold text-gray-800 mb-4">
              <span className="border-b-2 border-[#f69494] pb-1">スタッフ同士フォローし合える職場環境</span><br />
              <span className="text-[#f69494]">なので安心</span>
            </h3>
            <p className="text-sm text-gray-600 leading-relaxed">
        ...
        <div className="flex flex-col md:flex-row items-center gap-8 bg-white p-8 rounded-3xl shadow-sm">
          <div className="md:w-1/2">
            <img src="https://images.unsplash.com/photo-1507206130118-b5907f817163?auto=format&fit=crop&q=80&w=400" alt="No Experience" className="rounded-xl w-full" />
          </div>
          <div className="md:w-1/2">
            <h3 className="text-xl font-bold text-gray-800 mb-4">
              スキルや経験がなくても大丈夫
          ...
          <table className="w-full text-xs md:text-sm border-collapse">
            <tbody>
              {[
                ...
                { label: 'アクセス', content: '丸の内線「新宿御苑前駅」より徒歩3分\n丸の内線・副都心線「新宿三丁目駅」より徒歩4分' },
                { label: '連絡先', content: '050-5443-1770\n※お問い合わせの際には「採用ページを見て」とお伝えいただくとスムーズです' },
              ].map((row, idx) => (
                <tr key={idx} className="border-b border-[#f0e6d2] last:border-0">
                  <td className="w-1/4 p-4 font-bold text-gray-700 bg-[#fbf5e1]/50 border-r border-[#f0e6d2] text-center">{row.label}</td>
                  <td className="p-4 text-gray-600 whitespace-pre-line leading-relaxed">{row.content}</td>
                </tr>
              ))}
            </tbody>
          </table>
      ...
      <section className="container mx-auto px-4 max-w-4xl mb-20">
        ...
        <div className="bg-[#fefce8] rounded-[40px] p-8 md:p-16 shadow-sm border border-[#f0e6d2]">
          <form className="space-y-6">
            ...
            <div className="flex flex-col md:flex-row md:items-center gap-4">
              <div className="w-full md:w-1/3 flex items-center justify-between">
                <label className="text-sm font-bold text-gray-700">お住まいの都道府県</label>
                <span className="bg-[#f69494] text-white text-[10px] px-2 py-0.5 rounded">必須</span>
              </div>
              <div className="w-full md:w-2/3">
            ...
            <div className="flex flex-col md:flex-row md:items-center gap-4">
              ...
              <div className="w-full md:w-2/3 flex gap-6 text-sm text-gray-600">
                <label className="flex items-center gap-2 cursor-pointer">
                  <input type="radio" name="gender" className="w-4 h-4 accent-salon-pink" />
                  男性
                </label>
                <label className="flex items-center gap-2 cursor-pointer">
                  <input type="radio" name="gender" className="w-4 h-4 accent-salon-pink" />
            ...
            <div className="flex flex-col md:flex-row md:items-start gap-4">
              <div className="w-full md:w-1/3 flex items-center justify-between">
                <label className="text-sm font-bold text-gray-700">雇用形態</label>
                <span className="bg-[#f69494] text-white text-[10px] px-2 py-0.5 rounded">必須</span>
              </div>
              <div className="w-full md:w-2/3 grid grid-cols-2 gap-3 text-sm text-gray-600">
                {["正社員", "契約社員", "アルバイト", "業務委託"].map((item) => (
                  <label key={item} className="flex items-center gap-2 cursor-pointer">
                    <input type="radio" name="employment_type" className="w-4 h-4 accent-salon-pink" />
                    {item}
                  </label>
                ))}
              </div>
            ...
            <div className="flex flex-col md:flex-row md:items-center gap-4">
              <div className="w-full md:w-1/3 flex items-center justify-between">
                <label className="text-sm font-bold text-gray-700">希望勤務日数</label>
                <span className="bg-[#f69494] text-white text-[10px] px-2 py-0.5 rounded">必須</span>
              </div>
              <div className="w-full md:w-2/3 flex items-center gap-2 text-sm text-gray-600">
                週
                <select className="bg-white border border-gray-300 rounded px-3 py-1 text-sm focus:outline-none focus:ring-1 focus:ring-salon-pink">
                  <option>3</option>
                  <option>4</option>
                  <option>5</option>
                </select>
            ...
            <div className="flex flex-col md:flex-row md:items-start gap-4">
              <div className="w-full md:w-1/3 flex items-center justify-between">
                <label className="text-sm font-bold text-gray-700">希望勤務時間</label>
                <span className="bg-[#f69494] text-white text-[10px] px-2 py-0.5 rounded">必須</span>
              </div>
              <div className="w-full md:w-2/3 space-y-2 text-sm text-gray-600">
                {["9：30～19：00", "14：00～23：00", "19：00～2：00", "19：00～4：00", "19：00～6：00"].map((item) => (
                  <label key={item} className="flex items-center gap-2 cursor-pointer">
                    <input type="radio" name="work_time" className="w-4 h-4 accent-salon-pink" />
                    {item}
                  </label>
                ))}
              </div>
            ...
            <div className="flex flex-col md:flex-row md:items-start gap-4">
              <div className="w-full md:w-1/3 flex items-center justify-between">
                <label className="text-sm font-bold text-gray-700">コメント欄</label>
                <span className="bg-[#f8d7da] text-[#f69494] text-[10px] px-2 py-0.5 rounded border border-[#f69494]/30">任意</span>
              </div>
              <div className="w-full md:w-2/3">
                <textarea rows={4} className="w-full bg-white border border-gray-300 rounded px-3 py-2 focus:outline-none focus:ring-1 focus:ring-salon-pink"></textarea>
              </div>
            </div>
            ...
            <div className="pt-8 text-center text-[10px] text-gray-500 space-y-2">
              ...
              <p>お客様よりご登録いただいた個人情報は、弊社から事務的な連絡事項を通知するためにのみ使用します。</p>
              <p>※ 個人情報の取り扱いに同意される方のみ、確認画面にお進みください。</p>
            </div>
      ...
      <div className="container mx-auto px-4 max-w-4xl mt-12 pb-12 border-t border-gray-100">
        <nav className="py-4 text-[10px] text-gray-400">
          <Link to="/" className="hover:text-salon-pink">トップ</Link> &gt; <span className="text-gray-600">求人情報</span>
        </nav>
      </div>
    </div>
  );

  ...
  return (
    <div className="bg-salon-light min-h-screen pb-20 font-sans">
      ...
      <div className="container mx-auto px-4 pt-4 pb-2 text-[10px] text-gray-400">
        <Link to="/" className="hover:text-salon-pink">トップ</Link> &gt; <span className="text-gray-500 font-bold">Q&A</span>
      </div>
      ...
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        <div className="space-y-4">
          {FAQS.map((faq, idx) => (
            <div key={idx} className="bg-white rounded-xl shadow-sm border border-salon-gold/20 overflow-hidden group hover:border-salon-pink/30 transition-colors">
              {/* Question Row */}
        ...
        <div className="mt-12 py-4 border-t border-gray-100">
          <nav className="text-[10px] text-gray-400">
            <Link to="/" className="hover:text-salon-pink">トップ</Link> &gt; <span className="text-gray-500">Q&A</span>
          </nav>
        </div>
      </div>
    </div>

...
import { Sparkles, Diamond, ExternalLink } from 'lucide-react';
  ...
  return (
    <div className="bg-white min-h-screen pb-20 font-sans">
      ...
      <div className="container mx-auto px-4 pt-4 pb-2 text-[10px] text-gray-400">
        <Link to="/" className="hover:text-salon-blue">トップ</Link> &gt; <span className="text-gray-500 font-bold">会社概要</span>
      </div>
      ...
      <section className="container mx-auto px-4 max-w-4xl text-center mb-24">
        ...
        <div className="space-y-8 text-sm md:text-base text-gray-600 leading-loose max-w-2xl mx-auto">
          <p>
            SalonConciergeは、単なる電話代行にとどまらず、<br />
            サロンの“顔”としてお客様と繋がる第一線を担っています。<br />
            私たちは、店舗様・セラピスト様・お客様すべてにとって<br />
            心地よい体験を届けるため、<br />
            「丁寧な応対」「正確な情報提供」「臨機応変な対応力」を軸に、<br />
            業界最高水準のサービスを目指します。
          </p>
          <p>
            メンズエステ業界に特化した豊富な知見と実績を活かし、<br />
      ...
      <section className="container mx-auto px-4 max-w-4xl mb-24">
        ...
        <div className="grid grid-cols-1 md:grid-cols-1 gap-4">
          {[
            ...
            <div key={item.id} className="bg-white border border-salon-gold p-6 rounded-lg flex gap-6 items-start shadow-sm">
              ...
              <div>
                <h3 className="text-lg font-bold text-gray-700 mb-2">{item.id}. {item.title}</h3>
      ...
      <section className="container mx-auto px-4 max-w-4xl mb-24 text-center">
        ...
        <div className="mb-12">
          <h2 className="text-5xl font-bold text-gray-800 tracking-tighter mb-2">Luvina</h2>
          <p className="text-xl tracking-[0.5em] text-gray-400 -mr-[0.5em]">TOKYO</p>
        </div>
        ...
        <div className="max-w-xl mx-auto text-sm md:text-base text-gray-600">
          <div className="space-y-4 text-left">
            {[
              ...
              { label: '事業内容', content: '電話受付代行／コンサルティング' },
              ...
              <div key={idx} className="flex border-b border-gray-100 py-2">
                <span className="w-1/3 font-bold text-gray-500">{row.label}：</span>
      ...
      <section className="container mx-auto px-4 max-w-4xl text-center mb-24">
        ...
        <div className="space-y-8 text-gray-600 mb-12">
          <div>
            <h3 className="text-2xl font-bold text-gray-800 mb-2">株式会社Luvina</h3>
          ...
          <div className="space-y-2">
            ...
            <p className="text-sm">・丸ノ内線「新宿御苑前駅」1番出口より徒歩3分</p>
            <p className="text-sm">・丸ノ内線・副都心線「新宿三丁目駅」C8出口より徒歩4分</p>
          </div>
        ...
        <div className="bg-salon-light p-4 md:p-12 rounded-3xl border border-gray-200">
          <div className="text-center mb-8">
            <h3 className="text-lg font-bold text-gray-700 tracking-widest">【地図・ルート案内】</h3>
          </div>
      ...
      <div className="container mx-auto px-4 max-w-4xl mt-12 pb-12 border-t border-gray-100">
        <nav className="py-4 text-[10px] text-gray-400">
          <Link to="/" className="hover:text-salon-blue">トップ</Link> &gt; <span className="text-gray-600">会社概要</span>
        </nav>
      </div>
    </div>
  );
